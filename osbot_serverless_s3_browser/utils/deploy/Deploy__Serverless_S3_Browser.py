...
from osbot_serverless_s3_browser.lambdas.handler                                        import LAMBDA_DEPENDENCIES, run
...
BASE__LAMBDA_NAME  = 'serverless_s3_browser'        # make this a Safe_Str__Lambda_Name
