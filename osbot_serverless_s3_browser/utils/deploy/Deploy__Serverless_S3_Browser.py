...
# from osbot_serverless_s3_browser.fast_api.lambda_handler                                import LAMBDA_DEPENDENCIES, run
...
#
# BASE__LAMBDA_NAME  = 'serverless-s3-browser'        # make this a Safe_Str__Lambda_Name
#
#
